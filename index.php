    			...
    			<div class="modal-content">
      				...
      				<div class="modal-body" style="transition:height 0.7s ease-out;">
                        <div id="gf_first_form">
                            ...
                            <div class="form_row">
                                <div class="form_input_left">
                                    <div class="form_label_input">Nombre del juego/producto</div>
                                    <input type="text" name="gamename" class="form-control" id="gf_input_gamename">
                                </div>
                                <div class="form_input_right">
                                    <div class="form_label_input">Sitio de venta del juego/producto</div>
                            ...
                            <div class="form_row">
                                <div class="form_input_left">
                                    <div class="form_label_input">URL de tienda del juego/producto</div>
                                    <input type="text" class="form-control" id="gf_input_gameurl" placeholder="Ej: http://www.amazon.com/dp/B005WWZUQ0/">
                                </div>
                                <div class="form_input_right">
                                    <div class="form_label_input">Precio actual del juego/producto</div>
                            ...
                            <div class="form_row" style="margin:0;">
                                <div class="form_input_left">
                                    <div class="form_label_input">Juego/producto en oferta limitada</div>
                            ...
                            <div class="alert alert-warning" id="gf_offer_warning">Si hay una oferta limitada en Amazon, deberás informar el pago antes de que termine para que reservemos el juego.</div>
                        ...
                        <div id="gf_third_form">
                        	...
                        	<div class="gf_tf_transferinstructions">Una vez hecha la transferencia, envia una foto o imágen en la sección de <a href="informar/" target="_blank">informar pago</a> para que identifiquemos tu pago. El juego se enviará entre las siguientes 12 y 48 hs.</div>
                            
                            <div class="gf_tf_ticketinstructions">Una vez abonado, el juego se enviará en las 12-48 horas siguientes por e-mail.</div>
						
                             <div class="alert alert-warning gf_tf_offerwarning">El juego tiene una oferta de tiempo limitado. <strong>El pago deberá estar acreditado antes de que la oferta termine</strong> para que podamos enviar el juego.
                             De lo contrario se deberá hacer un cambio de productos.</div>
